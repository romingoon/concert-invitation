        ...
        <div className="px-6 space-y-5">
          ...
          >
            ...
            <div className="space-y-3.5 text-sm text-gray-700 leading-relaxed">
              ...
              <p>
                이번 제5회 새로핌 교회음악 페스티벌 연주회는 음악을 전공하지
                않은 일반 찬양대원들과 지휘자, 솔리스트가 함께 연주자로 나서
                각자의 신앙 이야기를 음악으로 고백하는 특별한 무대입니다.
              </p>
              <p>
                전문 성악가가 아닌 평범한 성도들이 주님을 향한 사랑으로 용기
                내어 무대에 섭니다. 전문적 기교보다는 진실한 마음으로,
                화려함보다는 순수한 열정으로 드리는 찬양입니다.
              </p>
            </div>
          </motion.div>
          {/* Planning Intent */}
          ...
          >
            ...
            <div className="space-y-3.5 text-sm text-gray-800 leading-relaxed">
              <p>
                ...
                걸어온 개인의 신앙 여정을 온전히 담아냅니다. 일반 찬양대원들이
                독창 무대에 선다는 것은 큰 도전이지만, 자신의 부족함을 내어놓고
                주님만을 의지하는 믿음의 행위입니다.
              </p>
              <p>
