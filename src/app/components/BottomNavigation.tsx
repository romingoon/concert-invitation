...
export function BottomNavigation({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/98 backdrop-blur-sm border-t border-stone-200 safe-area-inset-bottom z-50">
            ...
            >
              <motion.div className="relative" whileTap={{ scale: 0.92 }}>
                ...
                {isActive && (
                  <motion.div
                    layoutId="activeTab"
                    className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-1 h-1 bg-emerald-700 rounded-full"
